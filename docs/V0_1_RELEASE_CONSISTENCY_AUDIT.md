...
1. 读取 `docs/GITHUB_RELEASE_DRAFT.md` 更新 Release 正文；
2. 删除旧的 `LanHelper-v0.1.0-windows-x64.zip`；
3. 上传新的 `release-artifacts/LanHelper-v0.1.0-windows-x64.zip`；
4. 校验远程 asset digest 是否等于 `91617585501427da6bb2502e18ad28e0bc1038270c04db00364e7a4b04331a75`；
5. 保持 `Prerelease`。
