...
const STATIC_AUDIT_ITEMS: ProductStateConsistencyAuditItem[] = [
  ...
  },
  {
    ...
    label: '运行错误优先级',
    status: 'wired',
    evidence: 'hasError、runtime errors、auth_error、ip_mac_conflict、not_responding、last_error 会统一进入 has_problem。',
    manualCheck: 'Supernode 无响应、IP/MAC 冲突或认证失败时，所有页面应提示去诊断，而不是继续邀请。',
  },
  {
